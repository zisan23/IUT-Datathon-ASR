...
@registry.register_model("bengali_t5_transformer")
class BengaliT5Transformer(BaseModel):
    PRETRAINED_MODEL_CONFIG_DICT = {
        "default": "configs/models/bengali_t5_transformer.yaml",
    }
    ...
    def from_config(cls, cfg):
        ...
        normalize_flag = cfg.get("normalize_flag", True)
