...
@registry.register_model("bengali_umongwav2vec")
class BengaliUmongWav2Vec(BaseModel):
    PRETRAINED_MODEL_CONFIG_DICT = {
        "default": "configs/models/bengali_umongwav2vec.yaml",
    }

    def __init__(
            self,
            model_name="Umong/wav2vec2-large-mms-1b-bengali",
